  ...
  <div>
    ...
    <div class="relative w-full flex justify-center bg-stone-100">
      ...
      <div class="absolute top-4 left-4 flex gap-2">
        ...
        <div 
          ...
          class="text-white px-3 py-1 rounded-full text-xs font-semibold shadow"
        >
          {{ reference.is_available ? 'Disponible' : 'Indisponible' }}
        </div>
      </div>
    </div>
    ...
    <div class="p-8">
      ...
      <div class="flex gap-4">
        ...
        <button class="border border-stone-300 hover:border-amber-700 text-stone-700 hover:text-amber-700 px-6 py-3 rounded-lg font-semibold transition">
          Lire en directe
        </button>
      </div>
    </div>
