      ...
      <div class="overflow-x-auto">
        <table class="w-full">
          ...
          <tbody class="divide-y divide-gray-200">
            ...
            <tr v-else v-for="user in userStore.users" :key="user.id" class="hover:bg-gray-50 transition">
              <td class="px-6 py-4">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-5">
          ...
          <div>
            ...
            >
              ...
              <option value="responsable_d">Responsable Demande</option>
...
const getRoleBadgeClass = (role) => {
  const classes = {
    ...
    responsable_d: 'bg-green-100 text-green-700',
...
const getRoleLabel = (role) => {
  const labels = {
    ...
    responsable_d: 'Responsable Demande',
    user: 'Utilisateur',
  }
